...
contextBridge.exposeInMainWorld('nexus', {
  ...
  codingModelsStatus: () => ipcRenderer.invoke('coding-models:status'),
  saveCodingModelKey: (id, key) => ipcRenderer.invoke('coding-models:save-key', { id, key }),
  clearCodingModelKey: (id) => ipcRenderer.invoke('coding-models:clear-key', { id }),
  selectCodingModel: (id) => ipcRenderer.invoke('coding-models:select', { id }),
  askCodingModel: (prompt, folder) => ipcRenderer.invoke('coding-models:ask', { prompt, folder }),
  discoverProviders: () => ipcRenderer.invoke('provider-discovery:scan'),
  importEnvironmentProviderKey: (env) => ipcRenderer.invoke('provider-discovery:import-environment', { env }),
  useLocalProviderModel: (id, model) => ipcRenderer.invoke('provider-discovery:use-local', { id, model }),
  ...
  explainDiagnostic: (folder, filePath, currentContent, diagnostic) => ipcRenderer.invoke('diagnostics:explain-and-learn', { folder, filePath, currentContent, diagnostic }),
  ...
  wordpressOAuthConnect: () => ipcRenderer.invoke('oauth:wordpress-connect'),
  wordpressOAuthDisconnect: () => ipcRenderer.invoke('oauth:wordpress-disconnect'),
  wordpressSites: () => ipcRenderer.invoke('wordpress:sites'),
  ...
  userProfileGet: () => ipcRenderer.invoke('account-profile:get'),
  userProfileSave: (value) => ipcRenderer.invoke('account-profile:save', value),
  ...
  emailAccountSignIn: (email, password) => ipcRenderer.invoke('email-account:sign-in', { email, password }),
  emailAccountStatus: () => ipcRenderer.invoke('email-account:status'),
  emailAccountResendVerification: () => ipcRenderer.invoke('email-account:resend-verification'),
  emailAccountResetPassword: (email) => ipcRenderer.invoke('email-account:reset-password', { email }),
  emailAccountSignOut: () => ipcRenderer.invoke('email-account:sign-out'),
  ...
  trainingSummary: () => ipcRenderer.invoke('training:summary'),
  trainingPrepare: () => ipcRenderer.invoke('training:prepare'),
  trainingChoosePython: () => ipcRenderer.invoke('training:choose-python'),
  trainingStart: (options) => ipcRenderer.invoke('training:start', options),
  trainingStatus: (jobId) => ipcRenderer.invoke('training:status', { jobId }),
