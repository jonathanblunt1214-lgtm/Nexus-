...
contextBridge.exposeInMainWorld('nexus', {
  ...
  runTestsDetailed: (folder, testNamePattern, options) => ipcRenderer.invoke('run-tests-detailed', { folder, testNamePattern, ...(options || {}) }),
  discoverTests: (folder) => ipcRenderer.invoke('tests:discover', { folder }),
  testWatchStart: (folder) => ipcRenderer.invoke('tests:watch-start', { folder }),
  testWatchStop: (folder) => ipcRenderer.invoke('tests:watch-stop', { folder }),
  updateSnapshots: (folder, pattern) => ipcRenderer.invoke('tests:update-snapshots', { folder, pattern }),
  debugTest: (folder, testName) => ipcRenderer.invoke('tests:debug', { folder, testName }),
  ...
  oauthConfiguration: () => ipcRenderer.invoke('oauth:configuration'),
